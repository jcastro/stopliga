...
from stopliga.routers.mikrotik import MikroTikRouterDriver  # noqa: E402
...
class RouterFactoryTests(unittest.TestCase):
    ...
    def test_factory_creates_mikrotik_driver(self) -> None:
        driver = create_router_driver(Config(router_type="mikrotik"))  # type: ignore[arg-type]
        self.assertIsInstance(driver, MikroTikRouterDriver)
